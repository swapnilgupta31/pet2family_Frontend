...
async function addPet(event) {
    ...
    try {
        const response = await fetch('https://pet2family-backend.vercel.app/submit-pet-data', {
            method: 'POST',
            headers: {
...
async function fetchPetData() {
    try {
        const response = await fetch('https://pet2family-backend.vercel.app/fetch-pet-data');

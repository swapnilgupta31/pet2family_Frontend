...
async function BloggingData(event) {
    ...
    try {
        const response = await fetch('https://pet2family-backend.vercel.app/submit-blog-data', {
            method: 'POST',
            headers: {
...
async function fetchBlogPosts() {
    try {
        const response = await fetch('https://pet2family-backend.vercel.app/fetch-blog-posts');
